...
// eslint-disable-next-line
    ...
    return (
        <div className={'flex flex-col'}>
            <Toast ref={toast}/>
            {open &&
                <ConfirmOrder toast={toast} order={formData} open={open} close={handleCloseModalOrder} />
            ...
            <button type={'submit'}
                ...
                className={'flex bg-bgPrimary my-5 ml-auto mr-10 px-14 py-2 rounded font-bold text-white'}>
                Confirmar
            </button>
        </div>
    );
